...
import random
from src.portfolio.db_operations import write_market, read_market
...
massive_plan = os.getenv("MASSIVE_PLAN", "free").lower()

is_paid_massive = massive_plan == "paid"
is_realtime_massive = massive_plan == "realtime"
